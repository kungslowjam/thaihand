        ...
        <div className="rounded-3xl shadow-2xl bg-white/70 backdrop-blur-md px-8 py-10 flex flex-col items-center border border-white/40">
          ...
          <div className="flex flex-col gap-5 w-full">
            ...
            <Button
              ...
              disabled={isLoading}
              variant="outline"
              className="w-full flex items-center justify-center border-2 border-gray-200 bg-white hover:bg-green-50 text-gray-800 font-semibold text-lg py-4 rounded-xl shadow-sm hover:scale-105 transition-all duration-150"
            >
