...
export function GoogleLoginButton({ onError, className = "" }: GoogleLoginButtonProps) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      const errorMessage = 'เกิดข้อผิดพลาดในการเข้าสู่ระบบ Google กรุณาลองใหม่อีกครั้ง';
